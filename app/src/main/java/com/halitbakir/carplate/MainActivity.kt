package com.halitbakir.carplate

import androidx.appcompat.app.AppCompatActivity
import android.os.Bundle
import android.view.LayoutInflater
import android.view.WindowManager
import com.halitbakir.carplate.databinding.ActivityMainBinding
...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.button.setOnClickListener {
            if (binding.editTextNumber.text.isNotEmpty()){ //edittext içi dolu ise
                var plakaKodu= binding.editTextNumber.text.toString().toInt() //plakakodunu değişken içine gönderdik
                when(plakaKodu){
                    ...
                    46 -> binding.textView.text = "K.Maraş"
                    ...
                    81 -> binding.textView.text = "Düzce"
                        ...
                        binding.textView.text = "Yanlış bir değer girdiniz!"
                    }
                }

            }
            else{
                binding.textView.text = "Plaka kodunu girmediniz!" //boş değer girildiyse
            }
            binding.editTextNumber.text.clear() //plaka kodu gelince edittext içini temizleme
        }
